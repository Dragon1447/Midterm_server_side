    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('enail', models.CharField(max_length=150)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(decimal_places=2, max_digits=10)),
                ('discount', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('orderitem', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='shop.orderitem')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('payment_method', models.CharField(choices=[('QR', 'QR'), ('CREDIT', 'CREDIT')], max_length=6)),
                ('price', models.DecimalField(decimal_places=2, max_digits=10)),
                ('payment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shop.payment')),
            ],
        ),
